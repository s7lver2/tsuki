...
import { Tabs, Diff } from '../DocsComponents'
...
{`{
  ...
  "build": {
    ...
    "source_map": false
      ...
      <P>
        Your Go code is transpiled 1-to-1 to Arduino C++. Here's the diff for this sketch:
      </P>
      <Diff
        before={`package main
...
void loop() {
    ...
    delay(500);
        ...
        beforeLabel="src/main.go"
        afterLabel="build/blink/blink.cpp"
      />
