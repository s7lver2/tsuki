...
const STEPS = [
  ...
  },
  {
    ...
    tag: "Transpiler · Rust",
    color: "var(--ok)",
    desc: "Lexes, parses, and transpiles each .go file to .cpp. Emits stub .ino. ~11ms for 200-line file.",
  ...
  },
  {
    ...
    tag: "Packages · TOML",
    color: "var(--warn)",
    desc: "Resolves package imports, downloads & verifies Ed25519-signed TOML manifests, injects #include headers.",
    log: "  ✓ pkg         ws2812@1.0.0 injected",
  },
  {
    icon: "⚙",
    label: "tsuki-flash",
    tag: "Compiler · Rust",
    color: "var(--accent2)",
    desc: "Invokes avr-gcc / xtensa-gcc directly. SHA-2 incremental cache skips unchanged translation units.",
    log: "  ✓ compile     build/main/ → firmware.hex   3.2s",
  },
  {
    icon: "▲",
    label: "avrdude / esptool",
    tag: "Flash · native",
    color: "var(--accent)",
    desc: "Uploads firmware over USB. Board auto-detected via VID:PID. No arduino-cli in the chain.",
